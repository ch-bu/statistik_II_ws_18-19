...
Berechne als nächstes den Mittelwert und die Standardabweichung der Veriable percent_yes sowohl für die alten als auch für die neuen Bundesländer. Verwende hierfür die Funktion `group_by` und `summarise`:
